...
Some formal photo portraits still use black-and-white. Many visual-art photographers use black-and-white in their work."))?></textarea></td>
	...
	<form action="<?=site_url('api/book/isFav')?>" method="post" id="book_isFav">
		<table cellspacing="5" cellpadding="0">
			<tr>
				<th width="200"></th>
				<td><b>是否收藏过</b></td>
			...
			<tr>
				<th align="right">sign:</th>
				<td><input type="text" name="sign" value="<?php echo gsign('isFav', $timestamp)?>" /></td>
			</tr>
			<tr>
				<th></th>
				<td><input type="submit" value="提交" /></td>
	...
	<form action="<?=site_url('api/book/getMyReview')?>" method="post" id="book_getMyReview">
		<table cellspacing="5" cellpadding="0">
			...
			<tr>
				<th align="right">书本id:</th>
				<td><input type="text" name="bookId" value="14" /></td>
			</tr>																												
			<tr>
				<th align="right">random:</th>
				<td><input type="text" name="random" value="<?=$timestamp?>" /></td>
	...
	<form action="<?=site_url('api/user/getUserInfo')?>" method="post" id="user_getUserInfo">
		<table cellspacing="5" cellpadding="0">
			<tr>
				<th width="200"></th>
				<td><b>获取用户登陆信息</b></td>
			...
			<tr>
				<th align="right">sign:</th>
				<td><input type="text" name="sign" value="<?php echo gsign('getUserInfo', $timestamp)?>" /></td>
			</tr>
			<tr>
				<th></th>
				<td><input type="submit" value="提交" /></td>
	...
	<form action="<?=site_url('api/book/getFarPage')?>" method="post" id="book_getFarPage">
		<table cellspacing="5" cellpadding="0">
			<tr>
				<th width="200"></th>
				<td><b>获取阅读最大页</b></td>
			...
			<tr>
				<th align="right">bookId:</th>
				<td><input type="text" name="bookId" value="72" /></td>
			</tr>															
			<tr>
				<th align="right">random:</th>
				<td><input type="text" name="random" value="<?=$timestamp?>" /></td>
			...
			<tr>
				<th align="right">sign:</th>
				<td><input type="text" name="sign" value="<?php echo gsign('getFarPage', $timestamp)?>" /></td>
			</tr>
			<tr>
				<th></th>
				<td><input type="submit" value="提交" /></td>
