...
?>
<h2><span class="spantitle">书本<?=intval($this->input->get('id')) ? '修改' : '添加'?></span><div class="operate"><a href="<?=site_url('admin/book/lists')?>">管理</a></div></h2>
<div class="slider3">
	<form action="<?=site_url('admin/book/op'.(intval($this->input->get('id')) ? '?id='.intval($this->input->get('id')) : ''))?>" method="POST" enctype="multipart/form-data">
